...
computeMatrix scale-regions --scoreFileName $TERRA_AS_BW --regionsFileName $TERRA_INTERSECT \
--startLabel "peak start" --endLabel "peak end" --samplesLabel "TERRA" \
--upstream 2000 --regionBodyLength 3000 --downstream 2000 --binSize 10 \
--outFileName terra_reads_on_terra_intersecting_peaks.matrix.gz \
...
plotHeatmap --matrixFile $profile/terra_reads_on_terra_intersecting_peaks.matrix.gz \
--outFileName $figures/terra_reads_on_terra_intersecting_peaks_heatmap.pdf \
--outFileSortedRegions terra_reads_on_terra_intersecting_peaks.bed \
--kmeans 3

####################### TERRA ######################################
# terra read coverage on intersecting peak regions with 4 tandem telomeric repeats
computeMatrix scale-regions --scoreFileName $TERRA_AS_BW --regionsFileName $TERRA_INTERSECT_4tR \
--startLabel "peak start" --endLabel "peak end" --samplesLabel "TERRA" \
--upstream 2000 --regionBodyLength 3000 --downstream 2000 --binSize 10 \
--outFileName terra_reads_on_terra_intersecting_peaks_4tandem.matrix.gz \
--blackListFileName mm10.blacklist_telomeres.bed --numberOfProcessors max

# create a heatmap for scores over sets of genomic regions. split into clusters using kmeans clustering
plotHeatmap --matrixFile $profile/terra_reads_on_terra_intersecting_peaks_4tandem.matrix.gz \
--outFileName $figures/terra_reads_on_terra_intersecting_peaks_4tandem_heatmap.pdf \
--outFileSortedRegions terra_reads_on_terra_intersecting_peaks_4tandem.bed \
--kmeans 3

####################### TERRA ######################################
# terra read coverage on intersecting peak regions without 4 tandem telomeric repeats
computeMatrix scale-regions --scoreFileName $TERRA_AS_BW --regionsFileName $TERRA_INTERSECT_no4tR \
--startLabel "peak start" --endLabel "peak end" --samplesLabel "TERRA" \
--upstream 2000 --regionBodyLength 3000 --downstream 2000 --binSize 10 \
--outFileName terra_reads_on_terra_intersecting_peaks_no4tandem.matrix.gz \
--blackListFileName mm10.blacklist_telomeres.bed --numberOfProcessors max

# create a heatmap for scores over sets of genomic regions.
plotHeatmap --matrixFile $profile/terra_reads_on_terra_intersecting_peaks_no4tandem.matrix.gz \
--outFileName $figures/terra_reads_on_terra_intersecting_peaks_no4tandem_heatmap.pdf \
--outFileSortedRegions terra_reads_on_terra_intersecting_peaks_no4tandem.bed \
--kmeans 3
...
# --blackListFileName mm10.blacklist_telomeres.bed \
...
computeMatrix scale-regions --scoreFileName $RLOOP_BW --regionsFileName $TERRA_INTERSECT \
--startLabel "peak start" --endLabel "peak end" --samplesLabel "R-loop" \
--upstream 2000 --regionBodyLength 3000 --downstream 2000 --binSize 10 \
--outFileName rloop_reads_on_terra_intersecting_peaks.matrix.gz \
--blackListFileName mm10.blacklist_telomeres.bed --numberOfProcessors max

# create a heatmap for scores over sets of genomic regions.
plotHeatmap --matrixFile $profile/rloop_reads_on_terra_intersecting_peaks.matrix.gz \
--outFileName $figures/rloop_reads_on_terra_intersecting_peaks_heatmap.pdf \
--outFileSortedRegions rloop_reads_on_terra_intersecting_peaks.bed \
--kmeans 3

####################### R-loop ######################################
# rloop read coverage on intersecting peak regions with 4 tandem telomeric repeats
computeMatrix scale-regions --scoreFileName $RLOOP_BW --regionsFileName $TERRA_INTERSECT_4tR \
--startLabel "peak start" --endLabel "peak end" --samplesLabel "R-loop" \
--upstream 2000 --regionBodyLength 3000 --downstream 2000 --binSize 10 \
--outFileName rloop_reads_on_terra_intersecting_peaks_4tandem.matrix.gz \
--blackListFileName mm10.blacklist_telomeres.bed --numberOfProcessors max

# create a heatmap for scores over sets of genomic regions.
plotHeatmap --matrixFile $profile/rloop_reads_on_terra_intersecting_peaks_4tandem.matrix.gz \
--outFileName $figures/rloop_reads_on_terra_intersecting_peaks_4tandem_heatmap.pdf \
--outFileSortedRegions rloop_reads_on_terra_intersecting_peaks_4tandem.bed \
--kmeans 3

####################### R-loop ######################################
# rloop read coverage on intersecting peak regions without 4 tandem telomeric repeats
computeMatrix scale-regions --scoreFileName $RLOOP_BW --regionsFileName $TERRA_INTERSECT_no4tR \
--startLabel "peak start" --endLabel "peak end" --samplesLabel "R-loop" \
--upstream 2000 --regionBodyLength 3000 --downstream 2000 --binSize 10 \
--outFileName rloop_reads_on_terra_intersecting_peaks_no4tandem.matrix.gz \
--blackListFileName mm10.blacklist_telomeres.bed --numberOfProcessors max

# create a heatmap for scores over sets of genomic regions.
plotHeatmap --matrixFile $profile/rloop_reads_on_terra_intersecting_peaks_no4tandem.matrix.gz \
--outFileName $figures/rloop_reads_on_terra_intersecting_peaks_no4tandem_heatmap.pdf \
--outFileSortedRegions rloop_reads_on_terra_intersecting_peaks_no4tandem.bed \
--kmeans 3


####################### ATRX ######################################
# atrx read coverage on intersecting peak regions
computeMatrix scale-regions --scoreFileName $ATRX_BW --regionsFileName $TERRA_INTERSECT \
--startLabel "peak start" --endLabel "peak end" --samplesLabel "ATRX" \
--upstream 2000 --regionBodyLength 3000 --downstream 2000 --binSize 10 \
--outFileName atrx_reads_on_terra_intersecting_peaks.matrix.gz \
--blackListFileName mm10.blacklist_telomeres.bed --numberOfProcessors max

# create a heatmap for scores over sets of genomic regions.
plotHeatmap --matrixFile $profile/atrx_reads_on_terra_intersecting_peaks.matrix.gz \
--outFileName $figures/atrx_reads_on_terra_intersecting_peaks_heatmap.pdf \
--outFileSortedRegions atrx_reads_on_terra_intersecting_peaks.bed \
--kmeans 3

####################### ATRX ######################################
# atrx read coverage on intersecting peak regions with 4 tandem telomeric repeats
computeMatrix scale-regions --scoreFileName $ATRX_BW --regionsFileName $TERRA_INTERSECT_4tR \
--startLabel "peak start" --endLabel "peak end" --samplesLabel "ATRX" \
--upstream 2000 --regionBodyLength 3000 --downstream 2000 --binSize 10 \
--outFileName atrx_reads_on_terra_intersecting_peaks_4tandem.matrix.gz \
--blackListFileName mm10.blacklist_telomeres.bed --numberOfProcessors max

# create a heatmap for scores over sets of genomic regions.
plotHeatmap --matrixFile $profile/atrx_reads_on_terra_intersecting_peaks_4tandem.matrix.gz \
--outFileName $figures/atrx_reads_on_terra_intersecting_peaks_4tandem_heatmap.pdf \
--outFileSortedRegions atrx_reads_on_terra_intersecting_peaks_4tandem.bed \
--kmeans 3

####################### ATRX ######################################
# atrx read coverage on intersecting peak regions without 4 tandem telomeric repeats
computeMatrix scale-regions --scoreFileName $ATRX_BW --regionsFileName $TERRA_INTERSECT_no4tR \
--startLabel "peak start" --endLabel "peak end" --samplesLabel "ATRX" \
--upstream 2000 --regionBodyLength 3000 --downstream 2000 --binSize 10 \
--outFileName atrx_reads_on_terra_intersecting_peaks_no4tandem.matrix.gz \
--blackListFileName mm10.blacklist_telomeres.bed --numberOfProcessors max

# create a heatmap for scores over sets of genomic regions.
plotHeatmap --matrixFile $profile/atrx_reads_on_terra_intersecting_peaks_no4tandem.matrix.gz \
--outFileName $figures/atrx_reads_on_terra_intersecting_peaks_no4tandem_heatmap.pdf \
--outFileSortedRegions atrx_reads_on_terra_intersecting_peaks_no4tandem.bed \
--kmeans 3
